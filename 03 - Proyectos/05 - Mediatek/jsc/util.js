...
//export const types = require('./support/types');

function isArray(ar) {
    return Array.isArray(ar);
}
const _isArray = isArray;
//module.exports.add; { _isArray as isArray };
...
const _isNullOrUndefined = isNullOrUndefined;
//export { _isNullOrUndefined as isNullOrUndefined };
...
//export { _isSymbol as isSymbol };

function isUndefined(arg) {
    return arg === void 0;
}
const _isUndefined = isUndefined;
//export { _isUndefined as isUndefined };

function isRegExp(re) {
    return isObject(re) && objectToString(re) === '[object RegExp]';
}
const _isRegExp = isRegExp;
...
const _isPrimitive = isPrimitive;
//export { _isPrimitive as isPrimitive };

//export const isBuffer = require('./support/isBuffer');
...
function log () {
    return console.log('%s - %s', timestamp(), format.apply(exports, arguments));
